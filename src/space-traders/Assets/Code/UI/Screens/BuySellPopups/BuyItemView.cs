...
{
    public sealed class BuyItemView : UIScreenView
    {
        ...
        [field: SerializeField] public Button ConfirmPurchaseBtn { get; private set; }
        [field: SerializeField] public Button CancelPurchaseBtn { get; private set; }
    }
}