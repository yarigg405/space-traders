...
public partial class GameEntity {
    ...
    static readonly Assets.Code.Gameplay.Features.TargetCollection.ReadyToCollectTargets readyToCollectTargetsComponent = new Assets.Code.Gameplay.Features.TargetCollection.ReadyToCollectTargets();
