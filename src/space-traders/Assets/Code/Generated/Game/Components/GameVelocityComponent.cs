...
public partial class GameEntity {
    ...
    public Assets.Code.Common.Components.Velocity velocity { get { return (Assets.Code.Common.Components.Velocity)GetComponent(GameComponentsLookup.Velocity); } }
    ...
    public GameEntity AddVelocity(UnityEngine.Vector2 newValue) {
        ...
        var component = (Assets.Code.Common.Components.Velocity)CreateComponent(index, typeof(Assets.Code.Common.Components.Velocity));
