...
public partial class GameEntity {
    ...
    public Assets.Code.Common.Components.CurrentMoveSpeed currentMoveSpeed { get { return (Assets.Code.Common.Components.CurrentMoveSpeed)GetComponent(GameComponentsLookup.CurrentMoveSpeed); } }
    ...
    public GameEntity AddCurrentMoveSpeed(float newValue) {
        ...
        var component = (Assets.Code.Common.Components.CurrentMoveSpeed)CreateComponent(index, typeof(Assets.Code.Common.Components.CurrentMoveSpeed));
