...
public partial class GameEntity {
    ...
    static readonly Assets.Code.Gameplay.Features.Lifetime.ProcessingDeath processingDeathComponent = new Assets.Code.Gameplay.Features.Lifetime.ProcessingDeath();
