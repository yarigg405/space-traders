...
{
    internal sealed class PlayerCanNotBeDockedSystem : ReactiveSystem<GameEntity>
    {
        private readonly IUIManager _uiManager;

        public PlayerCanNotBeDockedSystem(GameContext game, IUIManager uiManager) : base(game)
        {
